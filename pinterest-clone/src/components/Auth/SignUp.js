...
function SignUp() {
  ...
  return (
    <div className="h-screen w-screen">
      ...
      <input type="text" className="p-4 drop-shadow-sm bg-slate-50 outline-violet-500 border-none outline-2" value={username} onClick={handleUser} placeholder="Enter your Name"/>
      </div>
      <div className="flex flex-col gap-2 text-left">
